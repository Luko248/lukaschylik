...
async function generatePdf() {
    try {
        ...
        try {
            ...
            const logoResponse = await axios_1.default.get(logoUrl, { responseType: "arraybuffer" });
            ...
            doc.fillColor("#000000") // Ensure text is black
                .fontSize(8)
                .text(`Page ${currentPage} of ${totalPages}`, 50, doc.page.height - 50, { align: "center", width: doc.page.width - 100 });
            // Finalize PDF
            doc.end();
