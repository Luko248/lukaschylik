    ...
    <>
      <Section id="blog" centerContent={false}>
        <Container size="sm">
          ...
          <p
            class={cls(
              'text-sm lg:text-base 3xl:text-lg',
              'leading-relaxed font-light',
              'mb-8 md:mb-12',
              'text-gray-800 dark:text-gray-300',
              'font-mono text-pretty',
            )}>
            Články zamerané na moderné CSS, frontend architektúru a AI vo
            vývoji. Nájdete v nich praktické poznatky, experimenty aj konkrétne
            postupy z reálnych projektov.
          </p>
          <div
            class={cls(
