...
CSS sa dlhé roky opieralo o jednoduché pravidlo: **najprv poradie, potom specificita**. Autor verzus používateľ verzus prehliadač. Dnes k tejto osi pribúdajú nové mechanizmy, ktoré dávajú autorom viac kontroly a zároveň znižujú potrebu „špinavých“ hackov.

V tomto článku sa pozrieme na historické vrstvy kaskády, moderné Cascade Layers, novú špecifikáciu `@scope` a selektory, ktoré otvárajú nové možnosti práce so specificitou.

## Vrstvy tu boli vždy

CSS malo vždy tri oficiálne origins:
...
<table class="w-full border-collapse border border-gray-200 dark:border-gray-800 bg-gray-100 dark:bg-gray-900 text-left">
  <thead class="bg-gray-200 dark:bg-gray-800/70">
    <tr>
      <th class="px-4 py-3 border-b border-gray-300 dark:border-gray-700">Typ selektora</th>
      <th class="px-4 py-3 border-b border-gray-300 dark:border-gray-700">Váha</th>
    </tr>
  </thead>
  <tbody>
