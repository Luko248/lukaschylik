---
title: CSS scroll-driven animace 
subtitle: Revoluce webových animací bez JavaScriptu
description: Zapomeňte na knihovny jako ScrollReveal, AOS nebo Scroll Magic! Moderní CSS je hravě strčí do kapsy.
date: 2025-04-28
author: Lukáš Chylík
---

## CSS prochází velkou změnou.

Nástroj, který dlouhé roky sloužil jen na „barvičky, fonty, odsazení či layout“ pro naše weby a aplikace, se postupně transformuje na plnohodnotný jazyk pro tvorbu vizuální logiky. Představa, že budeme moci vytvářet věci jako dynamické layouty, CSS vrstvy, konvertovat barvy do libovolných formátů či spustit webové animace na základě interakce a scrollování, byla donedávna sci-fi. A právě o těchto “scroll-driven” animacích si dnes povíme víc.
...
## **`view-timeline-inset`: Nastavení offsetu časové osy viditelnosti**
...
- dvě hodnoty: Nastaví offset pro začátek a konec časové osy viditelnosti.
...
- `view-timeline-inset` definuje, _kdy se element považuje za viditelný, což ovlivňuje celou časovou osu viditelnosti_. Je to jako kdybyste posunuli kameru, abyste viděli element dříve nebo později.
