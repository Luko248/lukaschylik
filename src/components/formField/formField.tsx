...
const FormField = component$<FormFieldProps>(
  ({
    ...
    const inputClass = [
      ...
      "block w-full bg-transparent border-gray-600 dark:border-gray-400 border-b-1 px-2 md:px-6 py-2 md:py-4 user-invalid:border-red-500 user-valid:border-green-400 text-base text-black dark:text-white placeholder-gray-500 dark:placeholder-gray-400",
    ]
      .filter(Boolean)
      .join(" ");
