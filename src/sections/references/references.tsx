        ...
        <div class="relative grid grid-cols-1 xl:grid-cols-[8fr_5fr] gap-5 isolate xl:max-h-screen xl:overflow-auto">
          <div class="relative xl:sticky xl:top-0 xl:h-fit mb-8 xl:mb:0">
            ...
            <div class="content-fade-in">
              ...
              <p class="text-l lg:text-xl leading-relaxed font-light mb-16 text-gray-300 font-mono">
              ...
              <div class="video-carousel flex flex-row gap-4 mt-20 snap-x snap-mandatory max-w-[560px] overflow-auto">
                <iframe
